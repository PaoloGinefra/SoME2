...
<FadeBg color = 'black'>
  <TextContainer>
    ...
    A coloring of a directed graph is simply the assignmet of a color to each edge exiting a node such that no two edges from the same node have the same color.
