...
After a while — maybe hours, maybe days — he shouted in pure elation: '_EUREKA!!!_ I need to follow <Spoiler>ULUURU</Spoiler>'.
...
Iteratively, until we were to find a set with just one state.
    ...
    />
     ...
     <Caption>
      Enter a word and check if it's a synching one following the automabots. You can switch between the two scenarios clicking on the bottom button.
    </Caption>
