...
<FadeBg color = 'black'>
  <TextContainer>
    ...
    />
    <Caption>
      Enter a word made of Gs and Rs for the Conveyor Belt or made of Us, Rs, Ls and Ds for the Mine, select a starting state and compute the result. Then, follow the dot.
    </Caption>
