...
Our setups are officially represented as a directed graph:
    ...
    />
    <Caption>
      Enter a word made of Gs and Rs for the Conveyor Belt or made of Us, Rs, Ls and Ds for the Mine.
      Then you can select a starting state and animate the path taken by following the word that you entered.
    </Caption>
    <Controls
      actions={[
        'set-word',
