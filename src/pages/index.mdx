...
Finally applying all the possible transitions to the resulting sets of the previous step
...
In order to play to our individual strengths and availabilities we naturally divided into roles.
Keep in mind that this structure wasn’t rigid at all and we made sure to help each other in any way possible. This was our first time making something like this. We hope you enjoyed it and any kind of feedback is highly appreciated :)
