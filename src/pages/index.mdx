...
<Caption>
  ...
  <kbd>&rarr;</kbd>
  <kbd>&darr;</kbd>
  to choose where Avraham should go at crossroads. Click on Avraham to show the mine's map.
</Caption>
...
<Caption>
Touch the Lego barriers to switch their position to rotate the car roofs in the right orientation. 
