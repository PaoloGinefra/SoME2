...
<script
  async
  src="https://cdn.panelbear.com/analytics.js?site=syXnCOBTsy"
></script>

<script>
    window.panelbear = window.panelbear || function() { (window.panelbear.q = window.panelbear.q || []).push(arguments); };
    panelbear('config', { site: 'syXnCOBTsy' });
</script>
...
If you are interested in the code behind this article it’s available on <a href="https://github.com/PaoloGinefra/SoME2" target="blank">Github</a>
