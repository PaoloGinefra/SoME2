...
<span className="emoji">➕</span> You can remove or add barriers clicking ond the <kbd>-</kbd> and <kbd>+</kbd> buttons.

<span className="emoji">🔛</span> Once some barriers are added you can scroll horizontally to view them all
</Caption>
<TextContainer>
